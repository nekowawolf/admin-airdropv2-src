...
export default function CreatorsCategoryChart({ data }: { data: any[] }) {
    ...
    datasets: [
      {
        ...
        backgroundColor: [
          ...
          '#ef4444', '#a855f7', '#22c55e', '#0ea5e9', '#f97316'
        ],
        borderWidth: 0,
      },
    ],
  ...
  return (
    <div className="p-4 rounded-2xl shadow-md bg-[var(--fill-color)] border border-border-divider h-80">
      <h3 className="text-lg font-semibold text-primary mb-4">Creators by Category</h3>
